...
//  +----------------+              +----------------+
//
// This example is aimed at measuring the throughput of the NetmapNetDevice
// in a pure simulation. For this purpose two NetmapNetDevices, attached to
...
NS_LOG_COMPONENT_DEFINE ("NetmapNetDeviceSaturationExample");
...
main (int argc, char *argv[])
{
  ...
  fd.EnablePcap ("nm2nm-onoff-server", serverDevice);
  ...
  fd.EnablePcap ("nm2nm-onoff-client", clientDevice);
