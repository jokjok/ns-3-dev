...
#ifndef NETMAP_FD_READER_H
#define NETMAP_FD_READER_H
 ...
 */
class NetmapFdReader : public SimpleRefCount<NetmapFdReader>
{
public:
  NetmapFdReader();
  virtual ~NetmapFdReader();
...
protected:
   ...
   */
  virtual NetmapFdReader::Data DoRead (void) = 0;
